	...
	return (
		<div className="h-screen flex flex-col">
			<header className="shrink-0 border-b border-zinc-800/60 px-6 py-3.5 flex items-center justify-between">
				<div>
					<h1 className="text-base font-semibold tracking-tight">Likelihood Scorer</h1>
					<p className="text-[11px] text-zinc-500 mt-0.5">Score how likely a model would generate a specific reply</p>
				</div>
